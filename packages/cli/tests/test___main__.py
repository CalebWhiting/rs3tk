...
def test_main_forwards_to_cli_main() -> None:
    ...
    with patch("rs3tk_cli.cli.main") as mock_main:
        import rs3tk_cli.__main__ as main_module
...
class TestMainModule:
    ...
    def test_main_module_imports(self) -> None:
        ...
        from rs3tk_cli.__main__ import main
    ...
    def test_main_module_has_attributes(self) -> None:
        ...
        assert main_module.__name__ == "rs3tk_cli.__main__"
